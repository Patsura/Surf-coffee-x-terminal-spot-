...
function AccordionTrigger({ children, className }: React.HTMLAttributes<HTMLElement>) {
  return <summary className={cn("flex cursor-pointer list-none items-center justify-between py-4 text-left text-sm font-semibold transition-all hover:text-[#a57945] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d9b98c]/60 [&::-webkit-details-marker]:hidden", className)}>{children}<ChevronDown className="h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180" /></summary>;
}
